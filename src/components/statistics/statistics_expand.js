            ...
            <div className="col col-md-8 col-lg-9 main-section">
                <div className="row justify-content-between">
                    ...
                    <div className="col col-md-5 col-lg-4 time">
                        <h6><img src={clock} alt="" className="float-left"/> Time-Aware<br/> Modeling</h6>
                        ...
                        <div className="setup"><img src={toggle} alt=""/> Set up time-aware modeling</div>
                    </div>
                </div>
