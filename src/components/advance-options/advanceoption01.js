    ...
    <div className="row">
      <div className="col col-md-8 col-lg-9 main-section">
        ...
        <ul className="nav nav-tabs" id="myTab" role="tablist">
          <li className="nav-item" role="presentation">
            <a className="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Partitioning</a>
          </li>
          <li className="nav-item" role="presentation">
      ...
      <div className="col col-md-4 col-lg-3 sidebar bdr-lft">
        <div className="col-12 worker">
          <h6>
            <img src={worker} alt="" className="float-left stat" />
            <img src={worker01} alt="" 
            className="float-left drk" />Workers</h6>
        ...
        <div className="col-12 worker">
          <h6>
            <img src={status} alt="" 
            className="float-left stat"/> 
            <img src={status01} alt="" 
            className="float-left drk"/>Status</h6>
          <ul>
            <li>1. Uploading Data 
                <img src={tickmark} alt=""
                 className="float-right"/></li>
...
export default Advanceoption01;
