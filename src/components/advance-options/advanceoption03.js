    ...
    <div className="row">
      <div className="col col-md-8 col-lg-9 main-section">
        ...
        <ul className="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li className="nav-item" role="presentation">
            <a className="nav-link active" id="smart-tab" data-toggle="tab" href="#smart" role="tab" aria-controls="smart" aria-selected="false">Smart Downsampling</a>
          </li>
          <li className="nav-item" role="presentation">
          ...
          <li className="nav-item" role="presentation">
            <a className="nav-link" id="additional-tab" data-toggle="tab" href="#additional" role="tab" aria-controls="additional" aria-selected="false">Additional</a>
          </li>
        </ul>
        <div className="tab-content" id="myTabContent">
          ...
          <div className="tab-pane fade show active" id="smart" role="tabpanel" aria-labelledby="smart-tab">
            ...
            <h5>Run models using:</h5>
            <ul className="nav nav-pills mbw-1 mb-3" id="pills-tab" role="tablist">
              <li className="nav-item" role="presentation">
      ...
      <div className="col col-md-4 col-lg-3 sidebar bdr-lft">
        ...
        <div className="col-12 worker">
          ...
          <ul>
            <li>1. Uploading Data <img src={tickmark} alt="" className="float-right"/></li>
            <li>2. Reading raw data (Quick) <img src={tickmark} alt="" className="float-right"/><br/>
              <span>(24.344 sec.)</span></li>
            <li>3.Exploratory Data Analysis <img src={tickmark} alt="" className="float-right"/><br/>
     ...
     <div className="col-md-12" style={{paddingTop:"15px"}}>
            <Link to="/advanceoption04" className="col-md-12 btn-block" routerLinkActive="activebutton">
...
export default Advanceoption03;
