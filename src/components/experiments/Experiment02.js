  ...
  return (
    ...
    <div className="row">
        <div className="col">
            ...
            <span className="tag-sdo"><img src={dot3} width="6" alt=""/> Tag 1</span> <span
                className="tag-sdo"> <img src={dot1} width="6" alt=""/> Tag Line 2</span> <span
                className="tag-sdo"> <img src={dot4} width="6" alt=""/> Tag 3</span>
        </div>
        <div className="col col-md-7 quik">
            <div className="row">
                <div className="col">
                    <p>quick<br/>
            ...
            <div className="col">
                <div className="row">
                    ...
                    <div className="col col-md-6 col-lg-8">
                        <a href="#" className="exp-data">Data Quality Assessment</a>
                        <i><a href="#" className="exp-data">Explore the data</a></i>
                    </div>
                </div>
            </div>
            <div className="col col-md-5 col-lg-4 archive txtright">
                <a href="#"><img src={icn_archive} alt="" className="stat"/>
                        <img
                        src={icn_archive_01} alt="" className="drk"/> Explore the data</a> <a href="#">
                        <img
                        src={icn_settings} alt="" className="stat"/><img
                        src={icn_settings_01} alt="" className="drk"/> Settings</a> <a href="#">
                        <img
                        src={icn_refresh_cw} alt="" className="stat"/>
                        <img
